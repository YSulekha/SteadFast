...
public class DialogActivity extends AppCompatActivity {
    ...
    public static class DatePickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener{
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            //if "EditRecord", then set the date of notes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if "EditRecord", set the value of notes
    ...
    public void insertNewRecord(View view){
        ...
        if(mName.getText().toString().trim().equals("")) {
            mName.setError(getString(R.string.text_required));
        }
        else {
    ...
    public void deleteRecord(View view){
        ...
        Toast toast = Toast.makeText(view.getContext(),getString(R.string.record_deleted),Toast.LENGTH_LONG);
        toast.show();
        finish();
    }
